...
var elementClassName = "tinymce-graph";
...
var plugin = function plugin(editor, url) {
  ...
  editor.addCommand('uploadGraph', function (file) {
    var insertBtn = $('#insertButton');
    insertBtn.attr('disabled', true);
    insertBtn.addClass('mce-disabled');
    insertBtn.attr('aria-disabled', true);

    var loading_element = '<div id="tinymce_upload_progress" style="height: 40px;">' + '<p style="padding: 10px 10px; margin: 0px">Uploading, please wait...</p>' + '<div style="position: absolute; height: 3px; background-color: black; width: 0%" id="tinymce_upload_progress_bar"></div>' + '</div>';
  ...
  var openGraphEditor = function openGraphEditor(graphData) {
    // Open window
...
tinymce.PluginManager.add('graphTinymcePlugin', _plugin2.default);
